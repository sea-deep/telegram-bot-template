...
bot.command = () => {
  throw new Error(
    "⚠️ Telegraf's native `bot.command` is disabled in this repository to prevent middleware order collisions. Please create a command file in `src/commands/` instead!"
  );
};
